...
| Remote Control and distribution           | 0024–0026, 0032–0036 | These form one safety boundary: attended platform agents, release/update constraints, protocol-v2 cutover, and bounded ephemeral plain-text clipboard sharing. Do not weaken an exclusion by reading only one ADR. |
