...
public final class ScreenShareCaptureOptions: NSObject, VideoCaptureOptions, Sendable {
    ...
    /// Capture every window and surface on the selected display (macOS only).
    ///
    /// This is intentionally opt-in. The default keeps the existing
    /// application-scoped capture behavior for ordinary screen sharing.
    public let captureEntireDisplay: Bool
    ...
    public init(dimensions: Dimensions = .h1080_169,
                ...
                captureEntireDisplay: Bool = false,
                excludeWindowIDs: [UInt32] = [])
    {
        ...
        self.captureEntireDisplay = captureEntireDisplay
    ...
    override public func isEqual(_ object: Any?) -> Bool {
        ...
        return dimensions == other.dimensions &&
            ...
            captureEntireDisplay == other.captureEntireDisplay &&
    ...
    override public var hash: Int {
        ...
        hasher.combine(captureEntireDisplay)
