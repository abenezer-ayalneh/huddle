...
function SignalRoute({ className, style }: { className?: string; style: CSSProperties }) {
  return (
    <div
      className={className}
      aria-hidden="true"
      style={{ position: 'absolute', display: 'grid', gap: 8, width: 'min(40vw, 480px)', pointerEvents: 'none', ...style }}
    >
...
export default function ErrorSurface({ kind, digest, onRetry }: ErrorSurfaceProps) {
  ...
  return (
    <>
      ...
      <main
        className="huddle-error-surface"
        style={{
          ...shellStyle,
          position: 'relative',
          isolation: 'isolate',
      ...
      >
        ...
        <div
          className="huddle-error-container"
          style={{ position: 'relative', zIndex: 1, display: 'flex', width: 'min(100% - 40px, 1180px)', flexDirection: 'column', margin: '0 auto' }}
        >
                ...
                style={
                  {
                    width: 32,
                    height: 32,
                    '--huddle-logo-primary': 'var(--error-purple)',
                    '--huddle-logo-accent': 'var(--error-yellow)',
                    '--huddle-logo-play': 'var(--error-ink)',
                    '--huddle-logo-play-stroke': 'var(--error-surface)',
                  } as CSSProperties
                }
              />
              Huddle
            </Link>
            <span style={{ color: 'var(--error-faint)', fontFamily: fontMono, fontSize: 10, letterSpacing: '0.13em', textTransform: 'uppercase' }}>
              {isGlobal ? 'Root boundary' : 'Route boundary'}
            </span>
          </header>

          <div
            className="huddle-error-layout"
            style={{
              display: 'grid',
              flex: 1,
          ...
          >
            <section className="huddle-error-intro" aria-labelledby="error-surface-title" style={{ maxWidth: 560 }}>
              ...
              <p style={{ maxWidth: 500, margin: '26px 0 0', color: 'var(--error-muted)', fontSize: 'clamp(1rem, 1.5vw, 1.15rem)', lineHeight: 1.65 }}>
                {copy.lede}
              </p>
            ...
            <section
              ...
              style={{
                ...
                boxShadow: '14px 18px 0 color-mix(in srgb, var(--error-purple) 14%, transparent)',
              }}
            >
              <div
                style={{
              ...
              >
                <p
                  id="error-panel-title"
                  style={{ margin: 0, color: 'var(--error-purple)', fontFamily: fontMono, fontSize: 10, letterSpacing: '0.13em', textTransform: 'uppercase' }}
                >
                  {copy.panelLabel}
                </p>
                <span
                  ...
                  style={{
                    ...
                    boxShadow: '0 3px 10px color-mix(in srgb, var(--error-red) 42%, transparent)',
                  }}
                />
              </div>
              ...
              <div
                style={{
                  ...
                  border: '1px solid color-mix(in srgb, var(--error-red) 45%, var(--error-border))',
                  borderRadius: 16,
                  background: 'var(--error-background-deep)',
                  boxShadow: '8px 10px 0 color-mix(in srgb, var(--error-red) 12%, transparent)',
                }}
              >
                <HuddleIcon
                  aria-hidden="true"
                  style={
                    {
                      ...
                      height: 68,
                      '--huddle-logo-primary': 'var(--error-purple)',
                      '--huddle-logo-accent': 'var(--error-red)',
                      '--huddle-logo-play': 'var(--error-ink)',
                      '--huddle-logo-play-stroke': 'var(--error-surface)',
                    } as CSSProperties
                  }
              ...
              <p style={{ margin: '12px 0 0', color: 'var(--error-muted)', fontSize: 14, lineHeight: 1.55 }}>
                No action was completed on this surface. The next handoff can start cleanly.
              </p>
              ...
              >
                <span style={{ color: 'var(--error-purple)', fontFamily: fontMono, fontSize: 10, letterSpacing: '0.1em', textTransform: 'uppercase' }}>
                  Signal state
                </span>
                <code
                  style={{
                ...
                >
                  {digest ? `DIGEST ${digest}` : 'RETRY AVAILABLE'}
                </code>
              </div>
              ...
              <div className="huddle-error-actions" style={{ display: 'flex', flexWrap: 'wrap', gap: 10, marginTop: 24 }}>
                <button
                  ...
                  style={{
                    ...
                    flex: '1 1 160px',
                    padding: '11px 15px',
                    border: '1px solid var(--error-purple)',
                    borderRadius: 9,
